# Free hobby preview deploy (redirect)

> **Canonical doc:** **[oss-self-hosted-deploy.md](./oss-self-hosted-deploy.md)** — Coolify-first, FOSS PaaS on a VPS, Docker/`deploy/*.Dockerfile`, env matrix, migrations, health checks, optional Meili/Redis.
