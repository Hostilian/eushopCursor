    ...
    >
      <article className="text-ink/80 max-w-2xl space-y-6 text-lg leading-relaxed text-pretty">
        ...
        <p>
          ...
          space on real routes, open asks, and local shares in your cell—discovery, identity you can
          see, and chat that leads to a clear handoff. Settlement stays between you until regulated
          in-app payments exist.
        </p>
        <p>
